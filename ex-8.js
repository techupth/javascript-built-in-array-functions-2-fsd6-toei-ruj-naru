...
// Start coding here
//ต้องการ object เก็บยอดขายรวมของแต่ละจังหวัด
//ทุกยอดขายมี location บางยอดขาย location ซ้ำกัน
//ตั้ง key เป็นจังหวัด มี  value เป็นผลยอดรวม

const totalPaidByLocation = bills.reduce((acc, curr) => {
  //   console.log(acc);
  //   console.log(curr.location);
  //   console.log(curr.total);
  //   console.log(acc[curr.location] === undefined);
  if (acc[curr.location] === undefined) {
    acc[curr.location] = curr.total;
  } else {
    // console.log(acc[curr.location]);
    acc[curr.location] += curr.total;
  }
  //   console.log(acc);
  return acc;
